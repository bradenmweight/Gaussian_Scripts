...
mol modstyle 0 PARAM_CUBENUM CPK 0.800000 0.40000 30.000000 16.000000   # THIS IS BALL AND STICK
# Define the material
...
# BRADEN M. WEIGHT MODIFIED HERE, ~ BMW  7/12/2021 ~
#Benzene Resolution Settings
#render Tachyon PARAM_CUBEFILE.jpg "~/lib/vmd/tachyon_LINUXAMD64" %s -format JPEG -res 800 800 -o %s
# 62 CNT Resolution Settings
#render Tachyon PARAM_CUBEFILE.jpg "~/lib/vmd/tachyon_LINUXAMD64" %s -format JPEG -res 800 400 -o %s
# 40 CNT Resolution Settings
#render Tachyon PARAM_CUBEFILE.jpg "~/lib/vmd/tachyon_LINUXAMD64" %s -format JPEG -res 1200 100 -o %s
# 110 CNT Resolution Settings
#render Tachyon PARAM_CUBEFILE.jpg "~/lib/vmd/tachyon_LINUXAMD64" %s -format JPEG -res 1500 500 -o %s
# nitromethane Resolution Settings
#render Tachyon PARAM_CUBEFILE.jpg "~/lib/vmd/tachyon_LINUXAMD64" %s -format JPEG -res 800 1000 -o %s
# Ethylene Resolution Settings
#render Tachyon PARAM_CUBEFILE.jpg "~/lib/vmd/tachyon_LINUXAMD64" %s -format JPEG -res 2000 500 -o %s


# TMP Resolution Settings
render Tachyon PARAM_CUBEFILE.jpg "~/lib/vmd/tachyon_LINUXAMD64" %s -format JPEG -res 1000 1000 -o %s
...
def find_vmd(options):
    vmdpath="~/bin/vmd" # BRADEN M. WEIGHT changed here. BMW
...
def read_options(options):
    ...
    """ # BRADEN M. WEIGHT changed here, BMW
    print("Parameters:")
